...
## A. Data Collection
 ...
 - [ ] **A.4 Downstream bias mitigation**: Have we considered ways to include demographic data (e.g. race, gender) where possible to enable testing downstream results for biased outcomes?
