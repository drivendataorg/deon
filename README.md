...
To make the ideas contained in the checklist more concrete, we've included examples of times when things have gone wrong. We're paired these with the checklist questions to help illuminate where in process ethics discussions may have helped provide a course correction.
