...
To make the ideas contained in the checklist more concrete, we've compiled [examples](docs/references.md) of times when things have gone wrong. They're paired these with the checklist questions to help illuminate where in process ethics discussions may have helped provide a course correction.
