...
This is an ethics checklist for data scientists and data science teams.

The primary goal of this package is to make it easy to incorporate a data ethics checklist into existing tools and workflows. In addition to a [default checklist](#Default_Checklist) (which can be customized), the tool provides a one-line CLI to create or append this checklist to a wide set of common file formats. 

We support appending a checklist to existing analyses in [many formats](#Supported_file_types) or generating new files with a checklist that is ready to fill out or review. The checklist was inspired by an article published by O'Reilly: ["Checklists"]().
...
This will create a markdown file that can be added to your anal
...
To actually, change the checklist, submit a PR that edits:
 - 
